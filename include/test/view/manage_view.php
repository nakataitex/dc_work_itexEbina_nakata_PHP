...
<?php if (isset($product_data) && !empty($product_data)): ?>
    <table>
        ...
        foreach ($product_view_data as $value) { ?>
            <tr>
                <td class="product_name"><?php print $value["product_name"]; ?><br>
                    <form method="POST">
                ...
                <td class="product_qty"><?php print $value["stock_qty"]; ?>個<br>
                    <form method="POST">
                        <input type="hidden" name="product_id" value="<?php echo $value["product_id"]; ?>">
                ...
                <td class="product_public"><?php print ($value["public_flg"] === "1") ? "公開中" : "非公開"; ?>
                    <br>
                    <form method="POST">
                        <input type="hidden" name="product_id" value="<?php echo $value["product_id"]; ?>">
